...
"""
print("Assignment 1: displaying the multiplication table from 10 to 1")
...
print("Assignment 2: Display the multiplication table horizontally")
...
while first < LIMIT:
    ...
    while second < LIMIT:
        second += 1
        print(f"{second:02} * {first:02} = {first * second:03}", end=" | ")    
    print()  # print("===============")
